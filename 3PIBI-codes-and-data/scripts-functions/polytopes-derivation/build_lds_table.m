...
% see Table II from https://arxiv.org/pdf/2406.11792

function V=build_lds_table(n) 
                                ...
                                for c21 = 0:1:n-c00-c01-c02-c10-c11-c12-c20
                                    for c22 = 0:1:n-c00-c01-c02-c10-c11-c12-c20-c21
                                        if c00+c01+c02+c10+c11+c12+c20+c21+c22==n
                                            ...
                                            current_table = [current_table; [1 P00 P01 P10 P11 P0000 P0100 P1100 P0001 P0101 P1001 P1101 P0011 P0111 P1111]];
                                        end
                                    end
                                end
                            end
